...
public static class LuneLibUtils
{
    ...
    public static bool MPLL => MultiplayerLL(L);
    ...
    /// <summary>
    /// Checks if its my player
    /// Multiplayer compatible
    /// </summary>
    /// <param name="player"></param>
    /// <returns></returns>
    public static bool MultiplayerLL(this Player player)
    {
        if (Main.netMode != NetmodeID.SinglePlayer)
        {
            return player.whoAmI == LuneSync.LuneWhoAmI;
        }
    ...
    public static void FuckingShit(string msg)
    {
